# JusticeGuide (AskLawyers) - Comprehensive Project Documentation
...
1. **Document Preprocessing**: 
   - Indian Penal Code PDF is chunked into 140+ smaller documents
...
The system processes 140+ chunked legal documents from the Indian Penal Code, ensuring comprehensive coverage while maintaining fast response times.
